...
class IHDH(nn.Module):
    ...
    #     computed_1l[:,0] = prob_y_2l[:,0]
    #     computed_1l[:,1] = self.union(prob_y_2l[:,1:6])
    #     computed_1l[:,2] = prob_y_2l[:,6]
    #     computed_1l[:,3] = self.union(prob_y_2l[:,7:11])
    #     computed_1l[:,4] = self.union(prob_y_2l[:,11:15])
    #     computed_1l[:,5] = prob_y_2l[:,15]
    #     computed_1l[:,6] = self.union(prob_y_2l[:,16:])
    #     return computed_1l
    ...
    def comp_prob_y_1l(self, prob_y_2l):
        computed_1l  = Variable(torch.ones(prob_y_2l.shape[0], self.tags_1l).type(self.dtype))
        # print(computed_1l.shape)
        computed_1l[:,0] = self.union(prob_y_2l[:,0:9])
        computed_1l[:,1] = self.union(prob_y_2l[:,9:17])
        computed_1l[:,2] = self.union(prob_y_2l[:,17:])
        return computed_1l
